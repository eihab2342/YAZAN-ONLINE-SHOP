...
<title><?php $pageTitle = 'Admin| Dashboard';
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2 text-white">Today Products</p>
                                <h6 class="mb-0"><?php echo countItems2('id', 'products_data') ?> product</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo countItems2('order_id', 'orders') ?> order</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2 text-white">Today </p>
                                <h6 class="mb-0">??</h6>
                            </div>
                        </div>
                    </div>
