...
?>
    ...
    <title><?php $pageTitle = 'YAZAN | Invoice'; echo getTitle($pageTitle) ?></title>
<?php
...
?>
    ...
    <div class="container text-white" style="direction: rtl;">
        <h3 class="text-center my-4">فاتورة</h3>
    ...
    <h3 class="text-right">المجموع الكلي: <?php echo $total_amount + ($total_amount * 0.05); ?> جنيه</h3>
