...
<header>
    <div class="container-fluid">
        ...
        <div class="row py-3 border-bottom align-items-center">
            <!-- Logo Section -->
            <div class="col-sm-4 col-lg-2 text-center text-sm-end">
                <div class="main-logo">
                    <a href="index.php" class="d-flex align-items-center justify-content-end text-decoration-none">
            ...
            <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
                ...
                <ul class="d-flex justify-content-end list-unstyled m-0">
                    <li><a href="account.php" class="rounded-circle bg-light p-2 mx-1"><svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#user"></use></svg></a></li>
                    <li><a href="#" class="rounded-circle bg-light p-2 mx-1"><svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg></a></li>
                    <li class="d-lg-none"><a href="#" class="rounded-circle bg-light p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart"><svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#cart"></use></svg></a></li>
                    <li class="d-lg-none"><a href="#" class="rounded-circle bg-light p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch" aria-controls="offcanvasSearch"><svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#search"></use></svg></a></li>
                </ul>
                <div class="cart text-end d-none d-lg-block dropdown">
                    <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                        <span class="fs-6 text-muted dropdown-toggle">Your Cart</span>
                        <span class="cart-total fs-5 fw-bold">123</span>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex justify-content-center justify-content-sm-between align-items-center">
                <nav class="main-menu d-flex navbar navbar-expand-lg">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                        ...
                        <div class="offcanvas-body">
                            <form method="GET" action="category.php" class="mt-2">
                                <select class="filter-categories border-0 mb-0 me-5" name="category_id" onchange="this.form.submit()">
                            ...
                            <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                                <li class="nav-item active"><a href="cart.php" class="nav-link">عربة التسوق</a></li>
                                <li class="nav-item dropdown"><a href="orders.php" class="nav-link">طلباتي</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
