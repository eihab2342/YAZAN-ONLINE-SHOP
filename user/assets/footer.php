          ...
          <div class="col-lg-2 col-md-6 col-sm-6">
            <div class="footer-menu">
                <div class="d-flex align-items-center justify-content-end">
                    <img src="../uploads/img/icon.png" alt="logo" style="height: 60px; width: 60px; ">
                    <div class="text-end">
    ...
    <div id="footer-bottom" class="bg-info p-3">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 copyright">
            <p class="fs-5">© <?php echo date("Y") ?> YAZAN | يزن. All rights reserved.</p>
          </div>
