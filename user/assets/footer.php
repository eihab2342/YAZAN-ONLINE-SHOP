    <footer class="mt-sm-5" style="margin-top: 60px; padding-top: 50px">
      <div class="container-fluid">
        <div class="row">

          <div class="col-lg-2 col-md-6 col-sm-6" style="margin-top: 50px; padding-top: 55px;">
    ...
    <div id="footer-bottom" class="bg-info p-2">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 copyright">
            <p style="font-size: 15px;">© <?php echo date("Y") ?> YAZAN | يزن. All rights reserved.</p>
          </div>
          <div class="col-md-6 credit-link text-start text-md-end" style="float: left;">
            <a href="../admin/eihab.php" class="team-link">فريق العمل</a>
          </div>

          <!-- CSS (يمكن إضافته داخل ملف CSS أو داخل وسم <style>) -->
        </div>
      </div>
    </div>
    <style>
      .team-link {
        ...
        /* إضافة تأثير عند المرور على الرابط */
      }

      .team-link:hover {
        color: #0056b3;
        /* تغيير اللون عند مرور الماوس على الرابط */
      }

      .credit-link {
        display: flex;
        justify-content: flex-start;
        /* محاذاة العناصر لليسار على الشاشات الصغيرة */
        justify-content: flex-end;
        /* محاذاة العناصر لليمين على الشاشات الكبيرة */
      }
    ...
    <!-- alert of added to cart -->
    <!-- <div id="notification" class="alert alert-success" style="display: none;">تم إضافة المنتج إلى العربة بنجاح ! </div>
    <style> -->

    <!-- Toast Notification 
      -->
    <div id="notification" class="toast align-items-center text-white bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="true">
      <div class="d-flex">
    ...
    transform: translateX(0); */
      /* التحرك بدون التأثير على التصميم */
      /* } */
    </style>
    <!-- alert of added to cart -->
    ...
    <script src="../uploads/js/swiper.js"></script>
